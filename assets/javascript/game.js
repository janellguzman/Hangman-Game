...
function resetGame() {
	...
	var htmlInstructions="<p><h3>Press any key to start!</p></h3>";
...
function displayProgress() {
    ...
    htmlStats = "<p><h3>Wins: " + wins + " Guesses Left : " + guessesLeft + "</h3></p>";
	document.querySelector("#stats").innerHTML = htmlStats;
...
function validateUserGuess() {
    // if user's pick doesn't exist in the array of prior picks, and it also doesn't exist in the array of the letters of the word
    // to be guessed, then reduce the guesses left by oneand make sure to verify user's pick is in the alphabet, otherwise ignore it.
...
// begin by breaking apart our selected word into an array of letter/flag
breakWordIntoArray();
